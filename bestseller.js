var bestsellersData = [
...

    {
       ...
       ,
       name: "R + F Lash Boost",
       price: "155.00 | $139.00 With perk",
       button: "ADD TO BAG",
    },

    {
       image_url:
          "https://www.rodanandfields.com/en-us/medias/ENHEY15-720x600-DESKTOP-v4.jpg?context=bWFzdGVyfGltYWdlc3w2MDYyOXxpbWFnZS9qcGVnfGltYWdlcy9oZDcvaGI2LzEzNTMzMTczODc0NzE4LmpwZ3w0MGI1MmM0OTExMmRiMzUzYzg5YTIyNWJjZTdiOTZkNzk1ZTVmOTk2MTBhY2IzZTcwNzhkZDI4NTUxZDI5Zjhh"
       ,
       name: "Active Hydration Bright Eye Complex",
       price: "$72.00 | $64.00 WithPC PERKS",
       button: "ADD TO BAG",
    },
...

    {
       ...
       ,
       name: "Rodan + Fields Enhancements Micro-...",
       price: "83.00 | $74.00 With perk",
       button: "ADD TO BAG",
    },
...
var cartData ;
   ...
   bestsellersData.forEach(function (bestsellerData) {
      ...
      name.textContent = bestsellerData.name;

      var price = document.createElement('price');
      price.textContent = `$${bestsellerData.price}`;

      var button = document.createElement('button');
      // cartButton.innerText = "ADD TO CART";
      button.innerText = bestsellerData.button;
